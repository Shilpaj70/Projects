...
lblInfo = Label(Tops, font=('helvetica', 30, 'bold'),
                text="Encryption & Decryption for SECRET MESSAGING \n Vigenère Cipher",
...
lblMsg = Label(f1, font=('arial', 16, 'bold'),
               text="Original MESSAGE", bd=16, anchor="w")
...
lblmode = Label(f1, font=('arial', 16, 'bold'),
                text="MODE(Press e for encrypt, d for decrypt)",
                bd=16, anchor="w")
